...
{
    [field: SerializeField][field: Range(0f, 100f)] public float BaseSpeed { get; private set; } = 5;
...
public class AttackInfoData
{
    ...
    [field: SerializeField][field: Range(0, 1f)] public float ComboTransitionTime { get; private set; }
    [field: SerializeField][field: Range(0, 3f)] public float ForceTransitionTime { get; private set; }
